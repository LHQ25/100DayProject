...
/*
 ...
 除了要求异步版本的迭代器，它在结构上和 Sequence 是完全一致的。
 异步迭代器的协议 AsyncIteratorProtocol 中，除了 next 是一个异步函数以外，其他也和同步版本的 IteratorProtocol 一样
 ...
 */
// 将序列改为 class
class ClassFibonacciSequence2: AsyncSequence {
    typealias Element = Int
