...
extension Api {
    ...
    enum Home: String {
        ...
        case topArticle = "article/top/json"

        case normalArticle = "article/list"

        case hotKey = "hotkey/json"

        case queryKeyword = "article/query/"
...
//            return Api.baseUrl + rawValue + "\(page)" + "json"
//        }
    }
}
