    ...
    return WaterfallFlow.builder(
        ...
        itemBuilder: (context, index){
          return GestureDetector(
            ...
            child: Column(
              children: [
                Image.asset("assets/images/test/test_a_${index%3}.png", width:(screen - 45) / 2.0, fit: BoxFit.fitWidth,),
                Padding(padding: const EdgeInsets.only(top: 15),
                  child: Text.rich(
                      maxLines: 2,
                      TextSpan(text:"Lot 1", style: semiBoldStyle(fontSize: 13, color: const Color(0xFF333333)),
                          children: [
                            TextSpan(text:"：清管彩开光-Gold Favrile Cup and mettere", style: mediumStyle(fontSize: 13, color: const Color(0xFF333333)))
                          ]
                      )),),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(padding: const EdgeInsets.only(top: 3),
                          child: Row(
                            children: [
                              Text("USD 23", style: semiBoldStyle(fontSize: 12, color: const Color(0xFF111111)),),
                              const Spacer(),
                              Image.asset("assets/images/home/home_collect.png", width: 17, height: 17,)
                            ],
                          ),)
                      ],)
                )
...
class _AuctionListPageViewState extends State<AuctionListPageView> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      padding: const EdgeInsets.symmetric(horizontal: 15),
        itemBuilder: (context, index) {
      return Padding(padding: const EdgeInsets.only(top: 15, bottom: 15),
      child: Row(
        children: [
          Image.asset("assets/images/test/test_a_0.png", width: 92, height: 82,),
          Expanded(
              child: Padding(
